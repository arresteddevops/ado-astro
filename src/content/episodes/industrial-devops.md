...
description: Doug Pagnutti spent fifteen years as an automation engineer caught between the IT and OT worlds inside manufacturing plants — and the friction sounds a lot like the DevOps wars of a decade ago. Matty and Doug dig into why industrial operations never got the memo, and what OT and IT could still learn from each other now that the wall between them is collapsing.
